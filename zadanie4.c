...
int main ( void )
{
    ...
    while ( 1 )
    {
        ...
        if(czas4 == 0 && czas3!=0  && start == 1)
        {
            czas3 -= 1;
            czas4 = 9;
        }
        else if(czas4 == 0 && czas3 == 0 && czas2!=0)
        {
            czas2 -= 1;
            czas3 = 5;
            czas4 = 9;
        }
        else if(czas4 == 0 && czas3 == 0 && czas2 == 0 && czas1!=0)
        {
            czas1 -= 1;
            czas2 = 9;
            czas3 = 5;
        ...
        LCD_PutChar(' ');
        LCD_PutChar(' ');
        LCD_PutChar(czas1+48);
        LCD_PutChar(czas2+48);
        LCD_PutChar(':');
        LCD_PutChar(czas3+48);
        LCD_PutChar(czas4+48);
        if(start == 1 && czas4!=0)
        {
            czas4 -= 1; 
        }
